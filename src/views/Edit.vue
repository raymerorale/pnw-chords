...
export default {
	...
	mounted(){
  		...
  		.then(data => {
  			this.title = data.foundSong.title,
  			this.artist = data.foundSong.artist,
  			this.chords = data.foundSong.chords,
  			this.stanza = data.foundSong.stanza,
  			this.stanzaCount = data.foundSong.stanzaCount
  		})
      	.catch((err =>alert(err)));
  	}
}
